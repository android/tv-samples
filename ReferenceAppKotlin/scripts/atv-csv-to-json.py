...
csv_columns_to_json_keys = {"id": "id", "name": "name", "description": "description", "uri": "uri", "video": "videoUri", "thumbnail": "thumbnailUri", "background": "backgroundUri", "category": "category", "type": "videoType"}
